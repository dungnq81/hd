...
<form name="ehd_2fa_form" id="loginform" action="<?php echo $args['action']; ?>" method="post">
	...
	<br />
	<p class="ehd-2fa-title"><?php esc_html_e( 'In order to log in, please enter the verification code from your Authenticator app:', EHD_TEXT_DOMAIN ); ?>
		<br />
...
<a href="<?php echo esc_url( $backup_codes_action ); ?>" style="text-align:center; display:block; padding: 10px">
	<?php esc_html_e( 'Login using backup codes', EHD_TEXT_DOMAIN ); ?>
</a>
