...
?>
<h2><?php _e( 'Security Settings', TEXT_DOMAIN ); ?></h2>
<div class="section section-checkbox" id="section_hide_wp_version">
    <label class="heading" for="hide_wp_version"><?php _e( 'Hide WordPress Version', TEXT_DOMAIN ); ?></label>
    <div class="desc"><?php _e( 'Many attackers scan sites for vulnerable WordPress versions. By hiding the version from your site HTML, you avoid being marked by hackers for mass attacks.', TEXT_DOMAIN )?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-checkbox" id="section_xml_rpc_off">
	<label class="heading" for="xml_rpc_off"><?php _e( 'Disable XML-RPC', TEXT_DOMAIN ); ?></label>
    <div class="desc"><?php _e( 'XML-RPC was designed as a protocol enabling WordPress to communicate with third-party systems but recently it has been used in a number of exploits. Unless you specifically need to use it, we recommend that XML-RPC is always disabled.', TEXT_DOMAIN )?></div>
	<div class="option">
		<div class="controls">
...
<div class="section section-checkbox" id="section_remove_readme">
	<label class="heading" for="remove_readme"><?php _e( 'Delete the Default Readme.html', TEXT_DOMAIN ); ?></label>
    <div class="desc"><?php _e( 'WordPress comes with a readme.html file containing information about your website. The readme.html is often used by hackers to compile lists of potentially vulnerable sites which can be hacked or attacked.', TEXT_DOMAIN ); ?></div>
	<div class="option">
		<div class="controls">
			<input type="checkbox" class="hd-checkbox hd-control" name="remove_readme" id="remove_readme" <?php checked( $remove_readme, 1 ); ?> value="1">
		</div>
		<div class="explain"><?php _e( 'Remove the readme.html', TEXT_DOMAIN ); ?></div>
	</div>
</div>
<div class="section section-checkbox" id="section_rss_feed_off">
	<label class="heading" for="rss_feed_off"><?php _e( 'Disable RSS and ATOM Feeds', TEXT_DOMAIN ); ?></label>
	<div class="desc"><?php _e( 'RSS and ATOM feeds are often used to scrape your content and to perform a number of attacks against your site. Only use feeds if you have readers using your site via RSS readers.', TEXT_DOMAIN ); ?></div>
    <div class="option">
		<div class="controls">
...
<div class="section section-checkbox" id="section_lock_protect_system">
    <label class="heading" for="lock_protect_system"><?php _e( 'Lock and Protect System Folders', TEXT_DOMAIN ); ?></label>
    <div class="desc"><?php _e( 'By enabling this option you are ensuring that no unauthorised or malicious scripts can be executed in your system folders. This is an often exploited back door you can close with a simple toggle.', TEXT_DOMAIN ); ?></div>
    <div class="option">
        <div class="controls">
...
<div class="section section-checkbox" id="section_advanced_xss_protection">
    <label class="heading" for="advanced_xss_protection"><?php _e( 'Advanced XSS Protection', TEXT_DOMAIN ); ?></label>
    <div class="option">
        <div class="controls">
        ...
        <div class="explain"><?php _e( 'Enabling this option will add extra headers to your site for protection against XSS attacks.', TEXT_DOMAIN ); ?></div>
    </div>
</div>
