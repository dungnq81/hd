...
<div class="section section-text" id="section_recaptcha_v2_site_key">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr_strip_tags( $recaptcha_v2_site_key ); ?>" class="hd-input hd-control" type="text" id="recaptcha_v2_site_key" name="recaptcha_v2_site_key">
        </div>
    </div>
</div>
...
<div class="section section-text" id="section_recaptcha_v2_secret_key">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr_strip_tags( $recaptcha_v2_secret_key ); ?>" class="hd-input hd-control" type="text" id="recaptcha_v2_secret_key" name="recaptcha_v2_secret_key">
        </div>
    </div>
</div>
...
<div class="section section-text" id="section_recaptcha_v3_site_key">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr_strip_tags( $recaptcha_v3_site_key ); ?>" class="hd-input hd-control" type="text" id="recaptcha_v3_site_key" name="recaptcha_v3_site_key">
        </div>
    </div>
</div>
...
<div class="section section-text" id="section_recaptcha_v3_secret_key">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr_strip_tags( $recaptcha_v3_secret_key ); ?>" class="hd-input hd-control" type="text" id="recaptcha_v3_secret_key" name="recaptcha_v3_secret_key">
        </div>
    </div>
</div>
...
<div class="section section-text" id="section_recaptcha_v3_score">
    ...
    <div class="option">
        <div class="controls">
            <input value="<?php echo esc_attr_strip_tags( $recaptcha_v3_score ); ?>" class="hd-input hd-control input-half" type="number" min="0.0" max="1.0" step="0.01" id="recaptcha_v3_score" name="recaptcha_v3_score">
        </div>
    </div>
</div>
